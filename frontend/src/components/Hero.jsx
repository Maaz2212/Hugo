...
// Memoized Image Component to prevent re-renders causing GIF resets
const HeroImage = React.memo(() => (
    <div className="hidden lg:block relative flex justify-end">
        <div className="relative w-full max-w-lg ml-auto">
            <img
                src="https://www.kavida.ai/wp-content/uploads/2024/11/Kavida-Header-GIF-1.gif"
                alt="Hugo Dashboard Preview"
                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
                    ...
                    <div className="text-left">
                        <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight text-gray-900 mb-6 font-display">
                            <RevealText text="Welcome to " />
                            <span className="text-blue-600">
                                <RevealText text="Hugo" delayStart={0.6} />
                            </span>
                        </h1>
                        <p className="max-w-lg text-lg sm:text-xl text-gray-600 mb-10 leading-relaxed text-left">
                            The ultimate platform to streamline your workflow and boost productivity.
                            Join thousands of satisfied customers today.
                        </p>

                        <div id="heroform" className="w-full max-w-md bg-white p-8 rounded-2xl shadow-xl border border-gray-100/50 backdrop-blur-sm">
